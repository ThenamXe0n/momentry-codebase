import { Bookmark, Grid3x3, Info, LogOut, Upload, UserRoundPen } from "lucide-react";
    ...
    <div className="p-4">
      ...
      <div className="mt-3">
        <div className="w-full grid grid-cols-2 gap-2">
          <button className=" text-white  bg-blue-400 rounded-sm gap-2 text-center flex items-center justify-center px-4 ">
            Edit profile
      ...
      {(posts.length >  0) ? (
        ...
        <div className="flex h-[30vh]  items-center justify-center">
          <div className=" w-11/12 p-5 rounded-md flex items-center bg-neutral-100 justify-center flex-col gap-6">
            <p className="text-neutral-400 capitalize flex items-center justify-center gap-2"> <Info/>No post to display</p>
            <Link to={pagePaths.post} className="px-3 py-1 rounded-md flex gap-2 items-center justify-center bg-blue-600 text-white">
              <Upload />
              upload post
            </Link>
          </div>
